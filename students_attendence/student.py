...
class Student:
    def __init__(self, root):
        ...
        dep_combo=ttk.Combobox(current_course,textvariable=self.var_dep,font=("Helvetica",12,"bold"),width=17,state="readonly")
        ...
        course_label = ttk.Combobox(current_course, textvariable=self.var_course, font=("Helvetica", 12, "bold"), width=17, state="readonly")
        course_label["values"] = (
        ...
        year_combo = ttk.Combobox(current_course, textvariable=self.var_year, font=("Helvetica", 12, "bold"), width=17, state="read only")
        year_combo["values"] = (
        ...
        semester_combo = ttk.Combobox(current_course, textvariable=self.var_semester, font=("Helvetica", 12, "bold"), width=17, state="read only")
        ...
        class_div_entry = ttk.Entry(class_student_frame, textvariable=self.var_div, width=20, font=("Helvetica", 12, "bold"))
        ...
        phone_entry = ttk.Entry(class_student_frame, textvariable=self.var_phone, width=20, font=("Helvetica", 12, "bold"))
        ...
        save_btn=Button(btn_frame,text="Save", command=self.add_data, width=15,font=("Helvetica", 12, "bold"), fg="white",
                                bg="#3bc55e")
        save_btn.grid(row=0,column=0)

        update_btn = Button(btn_frame, text="Update", width=15, font=("Helvetica", 12, "bold"), fg="white",
                          bg="#ddda36")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Delete", width=15, font=("Helvetica", 12, "bold"), fg="white",bg="#c53b52")
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Reset", width=15, font=("Helvetica", 12, "bold"), fg="white",bg="#be253f")
        reset_btn.grid(row=0, column=3)

        btn_frame1 = Frame(class_student_frame, bd=2, relief=RIDGE, bg="#04385f")
        btn_frame1.place(x=5, y=235, width=644, height=38)

        take_photo_btn = Button(btn_frame1, text="Take Photo Sample", width=31, font=("Helvetica", 12, "bold"), fg="white",bg="#3c0f4c")
        take_photo_btn.grid(row=1, column=0)

        update_photo_btn = Button(btn_frame1, text="Update Photo Sample", width=31, font=("Helvetica", 12, "bold"),fg="white",bg="#3c0f4c")
        update_photo_btn.grid(row=1, column=1)


        # right label frame
        right_frame = LabelFrame(main_frame, bd=2, bg="#04385f", relief=RAISED, text="Students Details",font=("Helvetica", 12, "bold"), fg="white")
        right_frame.place(x=695, y=10, width=520, height=470)

        # ===================================SEARCHING SYSTEM=============================================

        search_frame = LabelFrame(right_frame, bd=2, bg="#04385f", relief=RAISED,text="Search System",font=("Helvetica", 12, "bold"), fg="white")
        ...
        showAll_btn = Button(search_frame, text="Show All", width=7, font=("Helvetica", 12, "bold"), fg="white", bg="#FFC96F")
